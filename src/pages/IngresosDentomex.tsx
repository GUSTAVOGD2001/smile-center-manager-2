...
const API_URL_GET  = "https://script.google.com/macros/s/AKfycbyOb2bdJ2ctzgRdxPRz9xnUYQ-xi7DmZhg6j3EB1Dfz-zHouGoqw90aQPkAjxfRbxNc/exec?key=123Tamarindo";
const API_URL_POST = "https://script.google.com/macros/s/AKfycbyOb2bdJ2ctzgRdxPRz9xnUYQ-xi7DmZhg6j3EB1Dfz-zHouGoqw90aQPkAjxfRbxNc/exec";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold mb-2">Ingresos Dentomex</h1>
          <p className="text-muted-foreground">Gestión de ingresos Dentomex</p>
        </div>
        <Button
...
export default IngresosDentomex;
