...
const API_URL_GET  = "https://script.google.com/macros/s/AKfycbwhejyrQDl6Q3eum9vaRdfkSu68oUV2PP5UxL3c-FRkundXYJp1KdgnddnmY3vQFhow9Q/exec?key=123tamarindo";
const API_URL_POST = "https://script.google.com/macros/s/AKfycbwhejyrQDl6Q3eum9vaRdfkSu68oUV2PP5UxL3c-FRkundXYJp1KdgnddnmY3vQFhow9Q/exec";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold mb-2">Egresos Dentomex</h1>
          <p className="text-muted-foreground">Gestión de gastos Dentomex</p>
        </div>
        <Button
...
export default EgresosDentomex;
